        ...
        if (inboxVisible) {
            return (
                ...
                shadow-2xl">
                    ...
                    {/* messages */}
                    <div className={"flex-auto flex flex-col flex-grow-0"}>
                        ...
                        {/*form*/}
                        <form className="w-full max-w-sm border-t-2 border-gray-400" onSubmit={sendMessage}>
                            <Picker set='apple' size={16} />
